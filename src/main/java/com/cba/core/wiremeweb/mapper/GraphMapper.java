...
public class GraphMapper {
    ...
    public static GraphResponseDto toDto(GraphResponseDto responseDto, UserConfig userConfig) {
        responseDto.setPriorityOrder(userConfig.getPriorityOrder());
        responseDto.setStatus(userConfig.getStatus().getStatusCode());
        return responseDto;
    }

    public static UserConfig toModel(GraphRequestDto requestDto, String config, User user) {
