...
public class MerchantController implements MerchantResource<MerchantResponseDto, MerchantRequestDto> {
    ...
    @Override
    public ResponseEntity<List<MerchantResponseDto>> getAllByPageWise(int page, int pageSize) throws Exception {
    ...
    @Override
    public ResponseEntity<List<MerchantResponseDto>> searchAllByPageWise(List<Map<String, String>> searchParamList, int page, int pageSize) throws Exception {
    ...
    public ResponseEntity<String> deleteOne(int id) throws Exception {
        ...
        try {
            MerchantResponseDto responseDto = service.deleteById(id);
    ...
    public ResponseEntity<String> createBulk(List<MerchantRequestDto> requestDtoList) throws Exception {
        ...
        try {
            List<MerchantResponseDto> responseDtoList = service.createBulk(requestDtoList);
